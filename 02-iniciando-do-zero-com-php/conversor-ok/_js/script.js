    ...
    $('html').on('change', 'form.auto_save', function (e) {
        ...
        form.ajaxSubmit({
            ...
            success: function (data) {
                ...
                if (data.ex_11_result) {
                    $("#ex_11_result").text(data.ex_11_result);
                }
                if (data.ex_12_result) {
                    $("#ex_12_result").text(data.ex_12_result);
                }
                if (data.ex_13_result) {
                    $("#ex_13_result").html(data.ex_13_result);
                }
                if (data.ex_14_result) {
                    $("#ex_14_result").html(data.ex_14_result);
                }
                //CLEAR INPUT FILE
                if (!data.error) {
